...
// Example: load today's matches dynamically
const todayMatches = [
    { time: "14:00", teams: "Arsenal vs Chelsea", league: "Premier League", homeLogo: "arsenal-logo.png", awayLogo: "chelsea-logo.png", home: "Arsenal", away: "Chelsea", score: "2 - 1", prediction: "BTTS - Yes", confidence: 85, isFavorited: false },
    { time: "16:30", teams: "PSG vs Marseille", league: "Ligue 1", homeLogo: "psg-logo.png", awayLogo: "marseille-logo.png", home: "PSG", away: "Marseille", score: "3 - 0", prediction: "PSG Win", confidence: 90, isFavorited: true },
    { time: "18:00", teams: "Bayern Munich vs Borussia Dortmund", league: "Bundesliga", homeLogo: "bayern-logo.png", awayLogo: "dortmund-logo.png", home: "Bayern Munich", away: "Borussia Dortmund", score: "1 - 1", prediction: "Draw", confidence: 80, isFavorited: false },
    { time: "20:00", teams: "Juventus vs AC Milan", league: "Serie A", homeLogo: "juventus-logo.png", awayLogo: "milan-logo.png", home: "Juventus", away: "AC Milan", score: "1 - 2", prediction: "AC Milan Win", confidence: 75, isFavorited: true },
    { time: "22:00", teams: "Barcelona vs Real Madrid", league: "La Liga", homeLogo: "barcelona-logo.png", awayLogo: "real-madrid-logo.png", home: "Barcelona", away: "Real Madrid", score: "2 - 2", prediction: "Draw", confidence: 70, isFavorited: false }
];
...
todayMatches.forEach((match, index) => {
    ...
    card.innerHTML = `
        <div class="accordion accordion-flush" id="${accordionId}">
            <div class="accordion-item">
                <h2 class="accordion-header" id="${headingId}">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#${collapseId}" aria-expanded="${index === 0 ? 'true' : 'false'}" aria-controls="${collapseId}">
                        ${match.home} vs ${match.away}
                    </button>
                </h2>
                <div id="${collapseId}" class="accordion-collapse collapse ${index === 0 ? 'show' : ''}" aria-labelledby="${headingId}">
                    <div class="accordion-body">
                        ...
                        <div class="match-info">${match.league} • ${match.time}</div>
                        <div class="prediction-details">Prediction: ${match.prediction}</div>
                        <div class="tooltip-badge confidence-badge" tabindex="0" aria-describedby="tooltip-${index}">
                            Confidence: ${match.confidence}%
                            <span class="tooltip-texts" role="tooltip" id="tooltip-${index}">Confidence indicates likelihood of prediction accuracy</span>
                        </div>
                    </div>
                </div>
            </div>
